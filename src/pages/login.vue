                      ...
                      <div class=arco-tabs-content-inner style=margin-left:-100%>
                        <div class=arco-tabs-content-item role=tabpanel tabindex=-1 id=arco-tabs-6-panel-0
                          ...
                          <div class=arco-tabs-pane>
                            <div data-monitor-comp-id=c898301
                              data-monitor-comp-mark-id=78e84a46-1cfc-4bc6-ab9d-dded96b2d0f5>
                              <form class="arco-form arco-form-horizontal arco-form-size-default accountForm-L8eGbb">
                                <input id=username type=text name=fakeusernameremembered style=display:none value><input
                                  id=password type=password name=fakepasswordremembered style=display:none>
                                <div
                                  class="arco-row arco-row-align-start arco-row-justify-start arco-form-item arco-form-layout-horizontal formItem">
                                  <div class="arco-col arco-col-24 arco-form-item-wrapper">
                                    <div class=arco-form-item-control-wrapper>
                                      <div class=arco-form-item-control id=Identity>
                                        <div class=arco-form-item-control-children><span
                                            class="input-BO277k arco-input-inner-wrapper arco-input-inner-wrapper-default arco-input-clear-wrapper"><input
                                              name=Identity autocomplete=username id=Identity_input maxlength=50
                                              placeholder=请输入账号名/账号ID class="arco-input arco-input-size-default"
                                              value></span></div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div
                                  class="arco-row arco-row-align-start arco-row-justify-start arco-form-item arco-form-layout-horizontal formItem bottomFormItem-qb9xmM">
                                  <div class="arco-col arco-col-24 arco-form-item-wrapper">
                                    <div class=arco-form-item-control-wrapper>
                                      <div class=arco-form-item-control id=Password>
                                        <div class=arco-form-item-control-children>
                                          <div
                                            class="arco-input-group-wrapper arco-input-group-wrapper-default arco-input-has-suffix arco-input-password arco-input-password-visibility input-BO277k">
                                            <span class=arco-input-group><span
                                                class="arco-input-inner-wrapper arco-input-inner-wrapper-default"><input
                                                  type=password autocomplete=current-password id=Password_input
                                                  maxlength=50 placeholder=请输入登录密码
                                                  class="arco-input arco-input-size-default"><span
                                                  class=arco-input-group-suffix><svg fill=none stroke=currentColor
                                                    stroke-width=4 viewBox="0 0 48 48" tabindex=0
                                                    class="arco-input-password-visibility-icon arco-icon arco-icon-eye-invisible">
                                                    <path
                                ...
                                <div style=position:relative><button data-monitor-click-id=d585165
                                    class="arco-btn arco-btn-primary arco-btn-size-default arco-btn-shape-square btn-fC7tSF"
                                    type=submit><span>登录</span></button>
                                  <div id=pc_slide174920164142406ac8ce1></div>
                                </div>
                              </form>
                            </div>
                          </div>
                        ...
                        <div class="arco-tabs-content-item arco-tabs-content-item-active" role=tabpanel tabindex=0
                          ...
                          <div class=arco-tabs-pane>
                            <div data-monitor-comp-id=c75580
                              data-monitor-comp-mark-id=3c7542f2-c0c4-407c-b463-492b65204b7b>
                              <form autocomplete=off
                                ...
                                <div class=protocol-eGDdjF>登录视为您已阅读并同意火山引擎 <a
                                    ...
                                    href=https://www.volcengine.cn/docs/6256/64902 target=_blank
                                    rel="noopener noreferrer">隐私政策</a></div>
                                <div style=position:relative><button data-monitor-click-id=d90552
                                    class="arco-btn arco-btn-primary arco-btn-size-default arco-btn-shape-square btn-M2kVma"
                                    type=submit><span>登录 / 注册</span></button>
                                  <div id=pc_slide174920164246134e050d8></div>
                                </div>
                              </form>
                            </div>
                          </div>
...
<style>
  ...
  @-webkit-keyframes intelligent-assistant-loading-spin {
    0% {
  ...
  @keyframes intelligent-assistant-loading-spin {
    0% {
      -webkit-transform: rotate(0deg);
      transform: rotate(0deg)
    }
  ...
  @-webkit-keyframes volcfe-ai-hibot-loading-spin {
    0% {
      -webkit-transform: rotate(0deg);
      transform: rotate(0deg)
    }
  ...
  @keyframes volcfe-ai-hibot-loading-spin {
    0% {
      -webkit-transform: rotate(0deg);
      transform: rotate(0deg)
    }
...
<style>
  ...
  @-webkit-keyframes veIndex-module__animations--2KgaA {
    0% {
  ...
  @keyframes veIndex-module__animations--2KgaA {
    0% {
      -webkit-transform: rotate(0);
      transform: rotate(0)
    }
...
<style>
  ...
  .arco-input-inner-wrapper-focus:not(:first-child):not(:last-child),
  .arco-input-inner-wrapper-focus:not(:first-child):not(:last-child):hover {
    border-radius: 0
  }
...
<style>
  ...
  .arco-form-item-status-error .arco-input-inner-wrapper:not(.arco-input-inner-wrapper-disabled) .arco-input:not(.arco-input-disabled):hover {
    border: transparent
  }

  .arco-form-item-status-error .arco-input-inner-wrapper:not(.arco-input-inner-wrapper-disabled) .arco-input:not(.arco-input-disabled):focus {
    box-shadow: none
  }
  ...
  .arco-form-item-status-error .arco-input:not(.arco-input-disabled):focus,
  .arco-form-item-status-error .arco-input:not(.arco-input-disabled):focus:hover {
    box-shadow: 0 0 0 2px rgba(219, 55, 63, .3)
  }

  .arco-form-item-status-error .arco-input-group .arco-input-inner-wrapper-focus {
    border: 1px solid rgb(var(--danger-7));
    box-shadow: 0 0 0 2px rgba(219, 55, 63, .3)
  }

  .arco-form-item-status-error .arco-input-group .arco-input-inner-wrapper-focus:hover {
    border: 1px solid rgb(var(--danger-7));
    box-shadow: 0 0 0 2px rgba(219, 55, 63, .3)
  }

  .arco-form-item-status-error .arco-input-group-addbefore {
    border-bottom: 1px solid rgb(var(--danger-3));
    border-left: 1px solid rgb(var(--danger-3));
    border-top: 1px solid rgb(var(--danger-3))
  }

  .arco-form-item-status-error .arco-input-group-addbefore .arco-select:not(.arco-form-item-status-error .arco-input-group-addbefore .arco-select.arco-select-disabled) .arco-select-view {
    border-color: transparent
  }

  .arco-form-item-status-error .arco-input-group-addbefore .arco-select:not(.arco-form-item-status-error .arco-input-group-addbefore .arco-select.arco-select-disabled) .arco-select-view:first-of-type {
    border-radius: 4px 0 0 4px
  }

  .arco-form-item-status-error .arco-input-group-addbefore .arco-select:hover:not(.arco-form-item-status-error .arco-input-group-addbefore .arco-select:hover.arco-select-disabled) .arco-select-view {
    border-color: rgb(var(--danger-6))
  }

  .arco-form-item-status-error .arco-select:not(.arco-form-item-status-error .arco-select.arco-select-disabled) .arco-select-view {
    border: 1px solid rgb(var(--danger-3))
  }

  .arco-form-item-status-error .arco-select:not(.arco-form-item-status-error .arco-select.arco-select-disabled):hover .arco-select-view {
    border: 1px solid rgb(var(--danger-6))
  }

  .arco-form .arco-input-group .arco-input-inner-wrapper-focus:not(:first-child):not(:last-child) {
    border-radius: 0
  }

  .arco-form .arco-input-group-addbefore .arco-select-view:first-of-type {
    border-radius: 4px 0 0 4px
  }
...
<style>
  ...
  .layoutNew-s99CBg .footer-YtwIpo {
    align-items: center;
    box-sizing: border-box;
    display: flex;
    justify-content: center
...
<style>
  ...
  .login-isG0Ae .layoutSpin-pr7cPJ .cardHasTab-Uzr9RE .ouathIdpForLogin-xtuRdL {
    padding: 0 5px
  }
  ...
  .login-isG0Ae .layoutSpin-pr7cPJ .cardHasTab-Uzr9RE .accountTab-uAbUd4 .arco-tabs-header-nav {
    padding: 0 5px
  }

  .login-isG0Ae .layoutSpin-pr7cPJ .cardHasTab-Uzr9RE .accountTab-uAbUd4 .arco-tabs-content {
    padding-top: 8px
  }

  .login-isG0Ae .layoutSpin-pr7cPJ .cardHasTab-Uzr9RE .accountTab-uAbUd4 .arco-tabs-content .arco-form {
    box-sizing: border-box;
    padding: 0 5px
  }
  ...
  .login-isG0Ae .accountTab-uAbUd4 .arco-tabs-header-title:first-of-type {
  ...
  .login-isG0Ae .accountTab-uAbUd4 .arco-tabs-header-title+.arco-tabs-header-title {
    margin-left: 36px
  }
  ...
  .accountForm-L8eGbb .arco-form-item {
    margin-bottom: 20px
  }

  .accountForm-L8eGbb .input-BO277k {
    height: 40px
  }

  .accountForm-L8eGbb .input-BO277k .arco-input,
  .accountForm-L8eGbb .input-BO277k .arco-input-group {
    height: 38px
  }

  .accountForm-L8eGbb .bottomFormItem-qb9xmM {
    margin-bottom: 12px
  }

  .accountForm-L8eGbb .btn-fC7tSF {
    border-radius: 4px;
    box-shadow: 0 0 0 1px #05f, 0 2px 1px rgba(0, 0, 0, .15);
    font-size: 14px;
    font-weight: 500;
  ...
  .accountForm-L8eGbb .protocol-SyDruS {
    color: #41464f;
    font-size: 12px;
    font-weight: 400;
    line-height: 20px;
