  ...
  <div class="confirm-pay">
    ...
    <div class="confirm-content">
      ...
      <div class="alipay-content" v-if="payType === 'alipay'">
          ...
          <el-button @click="handleToAlipay" style="margin-top: 20px;" type="danger">登录支付宝账号付款{{ payMoney }}.00元</el-button>
      </div>
...
function getWxCode() {
  wxQrCode.value = getAssetsFile('suqare-icon.png') // 模拟获取二维码链接
}
