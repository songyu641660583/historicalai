<template>
  <svg aria-hidden="true" style="position:absolute;width:0px;height:0px;overflow:hidden">
    <symbol id="icon-pc_check" viewBox="0 0 1409 1024">
      <path
        d="M97.024 407.296l159.872-111.616 360.576 360.704L1273.6 0l135.68 135.68-791.808 792.064z"
        fill="#FFFFFF"
      />
    </symbol>
  ...
  <div class="confirm-pay">
    <div class="confirm-info">
      <div class="order-expire">
        订单提交成功，请尽快完成付款！支付订单号：{{orderNumber}}
        <div>
          请在倒计时
          <span class="countdown">22分58秒</span>
          前完成支付，否则订单会被自动取消
        </div>
      </div>
      <div class="order-money">
        <div>
          应付金额
          <span class="money">2.00</span>元
        </div>
        <div class="order-product">历史漫绘余额充值</div>
      </div>
    </div>
    <div class="confirm-content">
      ...
      <ul class="pay-channel">
        ...
        <li @click="handlePayChannel('alipay')">
          <div class="pay-channel-item line" :class="{' pay-channel-active':payType === 'alipay' }">
      ...
      <div class="qr-content">
        <div class="qrcode-info">
          ...
          <div class="qrcode-tips">二维码已过期</div>
        </div>
            ...
            <li class="limit_content">
              <div>
                ...
                <span>
                  ...
                  style="color: #3e97ff;"
                    target="_blank"
                    href="https://kf.qq.com/touch/sappfaq/151210NZzmuY151210ZRj2y2.html?platform=15&amp;ADTAG=veda.weixinpay.wenti&amp;code=023rCzgI0pN3zf2f6EdI0RoqgI0rCzgw&amp;state=123&amp;from=message&amp;isappinstalled=0"
                  >银行卡限额信息</a>
                </span>
              </div>
            </li>
...
const orderNumber = ref('143434343432')
...
.confirm-pay {
  ...
  .confirm-content {
    ...
    .pay-channel-item:hover:not(.pay-channel-active):not(
        .pay-channel-disabled
      ) {
    ...
    .pay-channel-info .channel-title {
      font-family: PingFangSC-Regular, system-ui, -apple-system, Segoe UI,
        Roboto, Ubuntu, Cantarell, Noto Sans, sans-serif, BlinkMacSystemFont,
        Microsoft Yahei, '微软雅黑', Oxygen-Sans, Helvetica Neue;
      font-size: 14px;
      color: #555;
    }
  }
