    ...
    <div class="header ">
      <div class="header-logo">
        <img
          ...
          width="84"
          height="22.13"
          src="../assets/9dbd484d8351690d1bf905bce6155cf3.png"
          alt="即梦AI"
        />
      </div>
        ...
        <div class="dropdown-base">
          ...
          <div class="base-info">
            <div class="base-info-name base-info-item">
              ...
              <span class="copy" @click="handleCopy(userInfo.name)"><el-icon size="12" color="#666"><CopyDocument /></el-icon></span>
            </div>
            <div class="base-info-item base-info-account">
              <span class="text">
                账号ID：{{userInfo.account}}
              </span>
              <span class="copy" @click="handleCopy(userInfo.account)"><el-icon size="12" color="#666"><CopyDocument /></el-icon></span>
            </div>
          </div>
        </div>
         <div class="logout-btn">   <el-button style="width: 100%;">退出登录</el-button></div>
      </div>
